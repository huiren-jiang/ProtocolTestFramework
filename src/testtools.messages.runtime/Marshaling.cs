...
namespace Microsoft.Protocols.TestTools.Messages.Marshaling
{
    ...
    {
        /// <summary>
        /// Indicates marshaling of the message.
        /// </summary>
        Marshal,

        /// <summary>
        /// Indicates unmarshaling of the message.
        /// </summary>
        Unmarshal
    }
    ...
    public struct MarshalingDescriptor
    {
        ...
        public override string ToString()
        {
            if (Attributes is ParameterInfo)
                return String.Format("parameter '{0}', type '{1}'", Attributes, Type);
            else if (Attributes is FieldInfo)
                return String.Format("field '{0}', type '{1}'", Attributes, Type);
            else
    ...
    public interface IRegion
    {
        ...
        /// <summary>
        /// Indicates whether to check space left when doing marshaling/unmarshaling.
        /// </summary>
    ...
    public abstract class MarshalingConfiguration
    {
        ...
        /// <summary>
        /// Looks up marshaler for the given marshaling descriptor.
        /// </summary>
        ...
        /// <summary>
        /// Looks up marshaler for given the marshaling descriptor, with or without processing indirect attribute and identifier binding attribute. 
        /// </summary>
        /// <param name="marshaler">The expected marshaler.</param>
        /// <param name="descriptor">The marshaling descriptor.</param>
        /// <param name="processIndirect">Indicates if processing an Indirect attribute.</param>
        /// <param name="processBinding">Indicates if processing an IdentifierBinding attribute.</param>
        /// <returns>The type marshaler.</returns>
                                                      ...
                                                      bool processIndirect, bool processBinding)
        {
            ...
            throw new InvalidOperationException(String.Format("cannot find marshaler for type '{0}'", descriptor.Type));
        }
    ...
    public class NativeMarshalingConfiguration : MarshalingConfiguration
    {
        ...
        private static MarshalingConfiguration configuration;
        /// <summary>
    ...
    internal class BooleanMarshaler : ITypeMarshaler
    {
        ...
        private int GetSize(MarshalingDescriptor desc, int defaultValue)
        {
            ...
            {
                throw new InvalidOperationException(
                    String.Format("Invalid static size '{0}' for bool in struct '{1}'", size, desc.Type.Name));
            }
            return size;
        }
    ...
    internal class CharMarshaler : ITypeMarshaler
    {
        ...
        private int GetSize(MarshalingDescriptor desc, int defaultValue)
        {
            ...
            {
                throw new InvalidOperationException(
                    String.Format("Invalid static size '{0}' for char in struct '{1}'", size, desc.Type.Name));
            }
            return size;
        }
    ...
    internal class StructMarshalerInline : ITypeMarshaler
    {
                                ...
                                object value)
        {
            ...
            MethodInfo method =
                desc.Type.GetMethod(methodName, BindingFlags.Public | BindingFlags.Static);
            if (method == null)
            {
                throw new InvalidOperationException(String.Format("Cannot find method '{0}' in struct '{1}'", methodName, desc.Type.Name));
            }
